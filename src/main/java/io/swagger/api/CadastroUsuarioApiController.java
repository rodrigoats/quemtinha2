...
@Controller
public class CadastroUsuarioApiController implements CadastroUsuarioApi {

    public ResponseEntity<Usuario> addUsuario(@ApiParam(value = "UsuÃ¡rio hÃ¡ ser cadastrado" ,required=true ) @RequestBody Usuario usuario) {
        // do some magic!
